class Solution {
    ...
    public int trapRainWater(int[][] heightMap) {
        ...
        // Priority queue (min-heap) to process boundary cells in increasing height
        // order
        ...
        while (!boundary.isEmpty()) {
            ...
            for (int direction = 0; direction < 4; direction++) {
                ...
                if (isValidCell(
                    ...
                    // If the neighbor's height is less than the current boundary height, water can
                    // be trapped
                    ...
                    // Push the neighbor into the boundary with updated height (to prevent water
                    // leakage)
                    boundary.offer(
                            new Cell(
    ...
    private static class Cell implements Comparable<Cell> {
        ...
        // Overload the compareTo method to make the priority queue a min-heap based on
        // height
        @Override
